...
# 1. Replace Par 4/5 Penalty Button with Side-by-Side 3-button layout
...
if old_par45 in content:
    ...
    print("SUCCESS: Replaced Par 4/5 Penalty buttons")
else:
...
old_par5_card3_vis = """          {/* CARD 3 (Par 5): 2nd Shot Distance */}
          {par === 5 && fairway !== null && (fairway !== 'na' || isTeeDrop) && ("""
new_par5_card3_vis = """          {/* CARD 3 (Par 5): 2nd Shot Distance */}
          {par === 5 && fairway !== null && (fairway !== 'na' || isTeeDrop) && ("""
# wait, wait, this might be named differently in the file now because git checkout restored it
old_par5_card3_vis2 = """          {/* CARD 3 (Par 5): 2nd Shot Distance — hidden when tee penalty active (distance auto-captured from Card 1) */}
          {par === 5 && (parseInt(teePenalty) || 0) === 0 && fairway !== null && fairway !== 'na' && ("""
new_par5_card3_vis2 = """          {/* CARD 3 (Par 5): 2nd Shot Distance */}
          {par === 5 && fairway !== null && (fairway !== 'na' || isTeeDrop) && ("""
if old_par5_card3_vis2 in content:
    content = content.replace(old_par5_card3_vis2, new_par5_card3_vis2)
    print("SUCCESS: Replaced Card 3 Visibility (Par 5)")
else:
    print("FAIL: Could not find old_par5_card3_vis2")
